function lpExportStructToCSV(events_struct, file_name, experiment)
...
fileTraits=[location, ',' , num2str(cellNum),',', mouse_dob,',', litter,',', num2str(toe), ',', mouse, ','];
...
%             disp(events_struct.frames(i).channels(j).units);
            ...
            for k=1:numEvents
                preamble=[num2str(experiment),',', num2str(i),',', num2str(j),',',num2str(k),','];
